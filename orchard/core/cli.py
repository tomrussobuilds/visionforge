...
def parse_args() -> argparse.Namespace:
    ...
    optuna_group.add_argument(
        ...
        type=int,
        default=1,
        help="Parallel trials (1=sequential, -1=all cores)"
    )
    ...
    optuna_group.add_argument(
        ...
        type=bool,
        default=True,
        help="Resume existing study or create new"
    )
    ...
    optuna_group.add_argument(
        ...
        type=bool,
        default=True,
        help="Export best trial as YAML config"
    )
